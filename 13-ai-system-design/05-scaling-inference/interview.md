# Scaling Inference — Interview Prep

## Q&A Outline

1. **Q: What problem does scaling inference solve?**
   **A:** A complete answer should connect the concept to latency budgets, batching, caching, model replicas, accelerator use, and degradation strategies.
...
8. **Q: How does this connect to adjacent topics?**
   **A:** Useful cross-links include [[quantization-inference]], [[serving]], [[autoscaling-cost]].
