# Recommendation Systems — Interview Prep

## Q&A Outline

1. **Q: What problem does recommendation systems solve?**
   **A:** A complete answer should connect the concept to candidate generation, ranking, features, feedback loops, exploration, and evaluation.
...
8. **Q: How does this connect to adjacent topics?**
   **A:** Useful cross-links include [[feature-stores]], [[evaluation-metrics]], [[search-ranking]].
