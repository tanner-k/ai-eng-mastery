# Feature Stores — Interview Prep

## Q&A Outline

1. **Q: What problem does feature stores solve?**
   **A:** A complete answer should connect the concept to offline/online feature consistency, freshness, point-in-time correctness, and serving contracts.
...
8. **Q: How does this connect to adjacent topics?**
   **A:** Useful cross-links include [[experiment-tracking]], [[serving]], [[search-ranking]].
