# Search Ranking — Interview Prep

## Q&A Outline

1. **Q: What problem does search ranking solve?**
   **A:** A complete answer should connect the concept to query understanding, candidate retrieval, ranking features, learning-to-rank, and online evaluation.
...
8. **Q: How does this connect to adjacent topics?**
   **A:** Useful cross-links include [[rag-architecture]], [[reranking]], [[feature-stores]].
