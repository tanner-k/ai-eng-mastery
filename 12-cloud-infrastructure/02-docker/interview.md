...
1. **Q: What problem does docker solve?**
   **A:** A complete answer should connect the concept to container images, layers, reproducible runtime environments, security, and build artifacts.
...
8. **Q: How does this connect to adjacent topics?**
   **A:** Useful cross-links include [[serving]], [[kubernetes]], [[cicd-for-ml]].
