...
1. **Q: What problem does kubernetes solve?**
   **A:** A complete answer should connect the concept to pods, deployments, services, config, scheduling, rollout, and health management.
...
8. **Q: How does this connect to adjacent topics?**
   **A:** Useful cross-links include [[docker]], [[gpu-provisioning]], [[autoscaling-cost]].
