# Serverless Inference — Interview Prep

## Q&A Outline

1. **Q: What problem does serverless inference solve?**
   **A:** A complete answer should connect the concept to scale-to-zero, cold starts, concurrency, timeout limits, and stateless inference contracts.
...
8. **Q: How does this connect to adjacent topics?**
   **A:** Useful cross-links include [[serving]], [[autoscaling-cost]], [[quantization-inference]].
