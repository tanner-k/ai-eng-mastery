# Terraform and IaC — Interview Prep

## Q&A Outline

1. **Q: What problem does terraform and iac solve?**
   **A:** A complete answer should connect the concept to declarative infrastructure, state, modules, environments, drift, and review workflows.
...
8. **Q: How does this connect to adjacent topics?**
   **A:** Useful cross-links include [[docker]], [[kubernetes]], [[autoscaling-cost]].
