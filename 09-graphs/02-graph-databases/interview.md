# Graph Databases — Interview Prep

## Q&A Outline

1. **Q: What problem does graph databases solve?**
   **A:** A complete answer should connect the concept to nodes, relationships, property graphs, queries, indexing, and transactional graph storage.
...
8. **Q: How does this connect to adjacent topics?**
   **A:** Useful cross-links include [[graph-algorithms]], [[graphrag-agent-memory]], [[agent-memory]].
