# GraphRAG and Agent Memory — Interview Prep

## Q&A Outline

1. **Q: What problem does graphrag and agent memory solve?**
   **A:** A complete answer should connect the concept to entity extraction, relation updates, graph retrieval, memory consolidation, and provenance.
...
8. **Q: How does this connect to adjacent topics?**
   **A:** Useful cross-links include [[graph-algorithms]], [[graph-databases]], [[agent-memory]].
