# MCP Servers and Clients — Interview Prep

## Q&A Outline

1. **Q: What problem does mcp servers and clients solve?**
   **A:** A complete answer should connect the concept to tool contracts, resource exposure, client/server boundaries, and safe tool invocation.
...
8. **Q: How does this connect to adjacent topics?**
   **A:** Useful cross-links include [[langchain]], [[langgraph]], [[agent-memory]].
