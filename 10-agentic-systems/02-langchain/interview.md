# LangChain — Interview Prep

## Q&A Outline

1. **Q: What problem does langchain solve?**
   **A:** A complete answer should connect the concept to chains, tools, retrievers, prompt composition, observability, and framework tradeoffs.
...
8. **Q: How does this connect to adjacent topics?**
   **A:** Useful cross-links include [[rag-architecture]], [[mcp-servers-clients]], [[langgraph]].
