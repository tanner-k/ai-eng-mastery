# RLHF and DPO — Interview Prep

## Q&A Outline

1. **Q: What problem does rlhf and dpo solve?**
   **A:** A complete answer should connect the concept to preference data, reward modeling, policy optimization, and direct preference objectives.
...
8. **Q: How does this connect to adjacent topics?**
   **A:** Useful cross-links include [[fine-tuning-lora-peft]], [[policy-gradients]], [[llm-evals]].
