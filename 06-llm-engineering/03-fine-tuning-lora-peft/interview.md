# Fine-Tuning (LoRA/PEFT) — Interview Prep

## Q&A Outline

1. **Q: What problem does fine-tuning (lora/peft) solve?**
   **A:** A complete answer should connect the concept to parameter-efficient adaptation, LoRA rank, freezing, adapters, and data quality.
...
8. **Q: How does this connect to adjacent topics?**
   **A:** Useful cross-links include [[transformers-attention]], [[rlhf-dpo]], [[llm-evals]].
