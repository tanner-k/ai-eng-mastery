# Quantization and Inference Optimization — Interview Prep

## Q&A Outline

1. **Q: What problem does quantization and inference optimization solve?**
   **A:** A complete answer should connect the concept to precision, memory bandwidth, latency, KV cache, batching, and serving tradeoffs.
...
8. **Q: How does this connect to adjacent topics?**
   **A:** Useful cross-links include [[transformers-attention]], [[scaling-inference]], [[llm-evals]].
