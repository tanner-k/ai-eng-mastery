# Transformers and Attention — Solutions
...
A complete answer should name the data model, allowed inputs, expected outputs, state or configuration, and invariants. For transformers and attention, pay special attention to the assumptions behind attention scores, masking, positional information, and transformer block structure.
...
The plan should turn "manual scaled dot-product attention on toy tensors" into a runnable lab with deterministic toy inputs, explicit assertions, and a short written interpretation. It should avoid hidden datasets or external services unless they are optional extensions.
