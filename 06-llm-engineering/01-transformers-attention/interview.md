# Transformers and Attention — Interview Prep

## Q&A Outline

1. **Q: What problem does transformers and attention solve?**
   **A:** A complete answer should connect the concept to attention scores, masking, positional information, and transformer block structure.
...
8. **Q: How does this connect to adjacent topics?**
   **A:** Useful cross-links include [[tokenization-embeddings]], [[fine-tuning-lora-peft]], [[llm-evals]].
