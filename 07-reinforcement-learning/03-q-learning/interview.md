# Q-Learning — Interview Prep

## Q&A Outline

1. **Q: What problem does q-learning solve?**
   **A:** A complete answer should connect the concept to temporal-difference targets, bootstrapping, off-policy control, and exploration.
...
8. **Q: How does this connect to adjacent topics?**
   **A:** Useful cross-links include [[mdps]], [[value-functions]], [[policy-gradients]].
