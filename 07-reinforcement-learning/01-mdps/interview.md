# Markov Decision Processes — Interview Prep

## Q&A Outline

1. **Q: What problem does markov decision processes solve?**
   **A:** A complete answer should connect the concept to states, actions, transitions, rewards, policies, returns, and discounting.
...
8. **Q: How does this connect to adjacent topics?**
   **A:** Useful cross-links include [[value-functions]], [[q-learning]], [[policy-gradients]].
