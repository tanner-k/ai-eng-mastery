# Policy Gradients — Interview Prep

## Q&A Outline

1. **Q: What problem does policy gradients solve?**
   **A:** A complete answer should connect the concept to stochastic policies, score-function gradients, baselines, variance, and advantage estimates.
...
8. **Q: How does this connect to adjacent topics?**
   **A:** Useful cross-links include [[mdps]], [[value-functions]], [[rlhf-dpo]].
