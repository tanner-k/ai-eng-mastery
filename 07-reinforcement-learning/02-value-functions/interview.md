# Value Functions — Interview Prep

## Q&A Outline

1. **Q: What problem does value functions solve?**
   **A:** A complete answer should connect the concept to state value, action value, Bellman expectation equations, and dynamic programming.
...
8. **Q: How does this connect to adjacent topics?**
   **A:** Useful cross-links include [[mdps]], [[q-learning]], [[policy-gradients]].
