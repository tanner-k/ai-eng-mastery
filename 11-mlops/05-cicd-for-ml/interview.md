# CI/CD for ML — Interview Prep

## Q&A Outline

1. **Q: What problem does ci/cd for ml solve?**
   **A:** A complete answer should connect the concept to pipeline automation, data validation, model tests, deployment gates, and rollback policy.
...
8. **Q: How does this connect to adjacent topics?**
   **A:** Useful cross-links include [[experiment-tracking]], [[model-registry]], [[monitoring-drift]].
