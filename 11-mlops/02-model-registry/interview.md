# Model Registry — Interview Prep

## Q&A Outline

1. **Q: What problem does model registry solve?**
   **A:** A complete answer should connect the concept to model versions, stages, approvals, artifacts, signatures, lineage, and rollback.
...
8. **Q: How does this connect to adjacent topics?**
   **A:** Useful cross-links include [[experiment-tracking]], [[serving]], [[cicd-for-ml]].
