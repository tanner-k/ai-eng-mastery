# Model Serving — Interview Prep

## Q&A Outline

1. **Q: What problem does model serving solve?**
   **A:** A complete answer should connect the concept to online inference APIs, batching, latency budgets, model loading, rollout, and rollback.
...
8. **Q: How does this connect to adjacent topics?**
   **A:** Useful cross-links include [[model-registry]], [[monitoring-drift]], [[serverless-inference]].
