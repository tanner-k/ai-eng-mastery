# Experiment Tracking — Interview Prep

## Q&A Outline

1. **Q: What problem does experiment tracking solve?**
   **A:** A complete answer should connect the concept to run metadata, parameters, metrics, artifacts, lineage, and reproducibility.
...
8. **Q: How does this connect to adjacent topics?**
   **A:** Useful cross-links include [[model-registry]], [[monitoring-drift]], [[cicd-for-ml]].
