# Monitoring and Drift — Interview Prep

## Q&A Outline

1. **Q: What problem does monitoring and drift solve?**
   **A:** A complete answer should connect the concept to data drift, concept drift, prediction monitoring, alerting, and feedback loops.
...
8. **Q: How does this connect to adjacent topics?**
   **A:** Useful cross-links include [[serving]], [[evaluation-metrics]], [[cicd-for-ml]].
