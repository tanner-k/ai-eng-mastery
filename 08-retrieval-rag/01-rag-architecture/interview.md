# RAG Architecture — Interview Prep

## Q&A Outline

1. **Q: What problem does rag architecture solve?**
   **A:** A complete answer should connect the concept to query analysis, retrieval, reranking, context assembly, generation, and citations.
...
8. **Q: How does this connect to adjacent topics?**
   **A:** Useful cross-links include [[bm25]], [[semantic-retrieval]], [[rag-evaluation]].
