# Hybrid Fusion — Interview Prep

## Q&A Outline

1. **Q: What problem does hybrid fusion solve?**
   **A:** A complete answer should connect the concept to sparse/dense score fusion, normalization, reciprocal rank fusion, and recall tradeoffs.
...
8. **Q: How does this connect to adjacent topics?**
   **A:** Useful cross-links include [[bm25]], [[semantic-retrieval]], [[reranking]].
