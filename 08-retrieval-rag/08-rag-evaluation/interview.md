# RAG Evaluation — Interview Prep

## Q&A Outline

1. **Q: What problem does rag evaluation solve?**
   **A:** A complete answer should connect the concept to retrieval recall, groundedness, faithfulness, answer quality, and regression testing.
...
8. **Q: How does this connect to adjacent topics?**
   **A:** Useful cross-links include [[rag-architecture]], [[llm-evals]], [[chunking-strategies]].
