...
A complete answer should name the data model, allowed inputs, expected outputs, state or configuration, and invariants. For rag evaluation, pay special attention to the assumptions behind retrieval recall, groundedness, faithfulness, answer quality, and regression testing.
...
The plan should turn "score a synthetic RAG trace for retrieval and answer failures" into a runnable lab with deterministic toy inputs, explicit assertions, and a short written interpretation. It should avoid hidden datasets or external services unless they are optional extensions.
