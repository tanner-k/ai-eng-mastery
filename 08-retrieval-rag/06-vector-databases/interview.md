# Vector Databases — Interview Prep

## Q&A Outline

1. **Q: What problem does vector databases solve?**
   **A:** A complete answer should connect the concept to ANN indexes, metadata filters, persistence, recall/latency, and operational constraints.
...
8. **Q: How does this connect to adjacent topics?**
   **A:** Useful cross-links include [[semantic-retrieval]], [[chunking-strategies]], [[rag-evaluation]].
