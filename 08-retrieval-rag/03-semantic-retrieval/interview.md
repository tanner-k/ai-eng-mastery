# Semantic Retrieval — Interview Prep

## Q&A Outline

1. **Q: What problem does semantic retrieval solve?**
   **A:** A complete answer should connect the concept to dense embeddings, similarity search, recall, indexing, and embedding drift.
...
8. **Q: How does this connect to adjacent topics?**
   **A:** Useful cross-links include [[tokenization-embeddings]], [[hybrid-fusion]], [[vector-databases]].
