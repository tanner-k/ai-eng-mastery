...
1. **Q: What problem does bm25 solve?**
   **A:** A complete answer should connect the concept to term frequency, inverse document frequency, length normalization, and sparse retrieval.
...
8. **Q: How does this connect to adjacent topics?**
   **A:** Useful cross-links include [[rag-architecture]], [[hybrid-fusion]], [[reranking]].
