# Reranking — Interview Prep

## Q&A Outline

1. **Q: What problem does reranking solve?**
   **A:** A complete answer should connect the concept to cross-encoders, late interaction, pairwise ranking, latency, and top-k tradeoffs.
...
8. **Q: How does this connect to adjacent topics?**
   **A:** Useful cross-links include [[hybrid-fusion]], [[rag-architecture]], [[rag-evaluation]].
